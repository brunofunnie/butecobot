...
$commands = [
    [
        'command' => 'test',
        'handler' => new TestCommand($discord, $config, $redis),
    ],
    [
        'command' => 'codigo',
        'handler' => new CodeCommand($discord, $config, $redis),
    ],
    [
        'command' => 'coins',
        'handler' => new CoinsCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'mestre',
        'handler' => new AskCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'perguntar',
        'handler' => new AskingCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'picasso',
        'handler' => new PaintCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'avioeszinhos',
        'handler' => new FlyCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'transferir',
        'handler' => new TransferCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'top',
        'handler' => new TopForbesCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ],
    [
        'command' => 'forbes',
        'handler' => new TopForbesCommand($discord, $config, $redis, $userRepository, $userCoinHistoryRepository),
    ...
    [
        'command' => 'evento',
        'handler' => new AdvertiseCommand($discord, $config, $eventRepository, $eventChoiceRepository),
    ],
    [
        'command' => 'anunciar',
        'handler' => new AdvertiseCommand($discord, $config, $eventRepository, $eventChoiceRepository),
    ...
    [
        'command' => 'apostar',
        'handler' => new BetCommand($discord, $config, $userRepository, $eventRepository, $eventBetsRepository),
    ],
    [
        'command' => 'evento',
        'handler' => new CreateCommand($discord, $config, $eventRepository),
    ],

];

foreach ($commands as $command) {
    $discord->listenCommand($command['command'], $command['handler']);
}
